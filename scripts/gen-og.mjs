...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="${W/2}" y="500" font-family="Helvetica, Arial, sans-serif" font-size="25" fill="#c7c8d6" text-anchor="middle">45 hand-verified sets · now graded for Alice / Q8</text>
